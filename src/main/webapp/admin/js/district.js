$(function(){
    ...
    $('#dg').datagrid({
        ...
        columns:[[
            ...
            {field:'s',title:'操作',width:120,
                formatter: function(value,row,index){
                    var str="<a href='javascript:delDistrict("+row.id+");'>删除</a>|<a href='javascript:updateDialog()'>修改</a>|<a href='javascript:OpenshowStreetDialog("+row.id+")'>街道详情</a>"
                    return str;
                }
            }
        ]]
